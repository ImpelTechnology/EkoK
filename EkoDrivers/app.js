...
function ConsumirServicio(url, tipo, datos, retorno) {
	var Resultado;
	$.ajax({
		url: url,
		type: tipo,
		...
		error: function (err) {
			if ((JSON.parse(err.responseText)).message == "Record with id null not found") {
				alert("Existe un servicio en estado 'Vehículo Asignado' que no tiene vehículo asignado");
			} else {
...
function cambiaestado(idestado) {
	var estados = [{ id: 6311625, estado: "Creado" },
	{ id: 6948340, estado: "En Asignación" },
	{ id: 6498048, estado: "Requiere Aprobación Tarifa" },
	{ id: 6535364, estado: "Requiere ajustar Fechas" },
	{ id: 6658658, estado: "Requiere Verificación de Flete" },
	{ id: 6948349, estado: "Vehículo Asignado" },
	{ id: 6957915, estado: "Confirmado" },
	{ id: 6951016, estado: "Cancelado" },
	{ id: 7075060, estado: "No Atendido" },
	{ id: 7016816, estado: "Creado" },
	{ id: 7016819, estado: "Habilitado" },
	{ id: 7016823, estado: "Inhabilitado" }
	];
	var estado;
	$.each(estados, function (index, objeto) {
		if (objeto.id == idestado) {
